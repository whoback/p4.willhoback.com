...
# What is the name of this app?
	define('APP_NAME', 'Remind.me');  

# When email is sent out from the server, where should it come from?
# Ideally, this should match the domain name
	define('APP_EMAIL', 'p4@willhoback.com'); 
...
*/ 	
	define('SYSTEM_EMAIL', 'will.hoback@gmail.com'); 

# Default DB name for this app
	define('DB_NAME', 'willhoba_p4'); 
...
# For this you could use gmail SMTP or something like http://sendgrid.com/
	define('SMTP_HOST', 'mail.willhoback.com');
	define('SMTP_USERNAME', 'p4@willhoback.com');
	define('SMTP_PASSWORD', 'p4%^&as;l');

# For extra security, you might want to set different salts than what the core uses
	define('PASSWORD_SALT', 'LaoRxWXkYvbqIfa0yHXxwmoMgrpvYxU&x%d@V5jK');
	define('TOKEN_SALT', '@YCXMAFpyIv^&pP&q^5%&L@4wDcjSe7)4%U*Ftck');